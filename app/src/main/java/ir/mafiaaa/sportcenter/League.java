...
public class League {
    ...
    public void initializeLeague() {
        ...
        Team parse_jonobi_jam = new Team();
        ...
        Team esteghlal_khozestan = new Team();
        ...
        Team esteghlal_tehran = new Team();
        ...
        Team teractor_sazi_tabriz = new Team();
        ...
        Team perspolis_tehran = new Team();
        ...
        Team siah_jamegan_mashad = new Team();
