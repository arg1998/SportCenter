...
public class Formation532 extends Fragment {
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        n6.setText("محسن ربیع‌خواه");

        n7.setText("فرشاد احمدزاده");
        n8.setText("کمال کامیابی‌نیا");
        n9.setText("احمد نوراللهی");
    ...
    public void showDialog(int Number){
        Custom_dialog custom_dialog = new Custom_dialog(getActivity(), Number, 532);
        custom_dialog.show();
    }
