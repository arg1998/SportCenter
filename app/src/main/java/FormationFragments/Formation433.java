 ...
 */
public class Formation433 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_formation433, container, false);
    }
    ...
    public void showDialog(int Number){
        Custom_dialog custom_dialog = new Custom_dialog(getActivity(), Number, 433);
        custom_dialog.show();
    }
